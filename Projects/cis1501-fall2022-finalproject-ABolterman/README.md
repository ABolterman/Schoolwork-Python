...
part 3 - Build a results table to show what strategy loses the least money - for each starting hand value, either hit or stand and track the result - just do a single hit or stand and then track win/lose/draw

simluate 100,000 hands, track our starting hand value and then randomly pick hit or stand, and track win/loss/draw result
